...
namespace processor
{
    ...
    public:
        ...
        ServerProcessor(const ServerProcessor &) = delete;
        ServerProcessor &operator=(const ServerProcessor &) = delete;
        ServerProcessor(ServerProcessor &&) = delete;
        ServerProcessor &operator=(ServerProcessor &&) = delete;
    ...
    private:
        ...
        std::chrono::seconds ruleInterval_{60}; // 60 секунд вместо 1 минуты
